...
export function estilo2(dados, primary, secondary, iniciais, corpo, fontFamily = "Georgia, 'Times New Roman', serif") {
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  body { font-family: ${fontFamily}; color: var(--text); line-height: 1.7; background: var(--bg); transition: background 0.3s, color 0.3s; }
