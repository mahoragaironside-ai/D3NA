  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      {subscription?.subscription_status !== "ativo" && (
        <div style={{ background: C.amberBg, color: C.amber, fontSize: 12.5, padding: "8px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span>Plano gratuito — 1 análise/mês.</span>
          <button onClick={onUpgrade} style={{ background: C.amber, color: "#fff", border: "none", borderRadius: 8, padding: "5px 10px", fontSize: 12, cursor: "pointer" }}>
